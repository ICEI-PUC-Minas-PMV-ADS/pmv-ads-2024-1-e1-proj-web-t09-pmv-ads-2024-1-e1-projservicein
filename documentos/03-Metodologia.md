...
Para execução do projeto foi utilizado editor de código, ferramenta de design (Penpot) além de ferramenta de comunicação.

O editor de código foi escolhido de acordo com a preferência do integrante. Dentre eles:

Virtual Studio Code
VSCodium
Github Desktop

A ferramenta Penpot foi escolhida pois se adequa as necessidades do projeto, facilitando a criação e a visualização dos layouts das telas. 
